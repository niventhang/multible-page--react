...
function Navtabs() {
    return (
        <Tabs 
            ...
            className="mb-3"
        >
            <Tab className='text-center text-lg-start' eventKey="Main" title=" Main skills">
            ...
            <Tab eventKey="Education & Certification" title="Education & Certification" >
                <Text text="BSc In CSE - ABC University, Los Angeles, CA" />
                <Text text="2010" />
                <Text style="pt-2" text="Diploma in Computer Science - Gamma Technical Institute" />
                <Text style="pb-2" text="2009" />
                <Text style="pt-2" text="Graphic Designer - ABC Institute, Los Angeles, CA" />
